<h1 class="page-header">Pak ordre  #<?php echo $order['Order']['id']; ?></h1>
...
<a style="font-size:1.3em;" href="
    <?php echo $this->Html->url(array('controller' => 'orders', 'action' => 'pack', $order['Order']['id'], 'true')); ?>
" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-ok"></span> Pakket</a>
</p>
