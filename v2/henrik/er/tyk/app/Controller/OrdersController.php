...
class OrdersController extends AppController 
{
    ...
    public function pack($order_id = null, $is_packed = false)
    {
        ...
        if(empty($order))
        {
            ...
            $this->Session->setFlash('Odren findes ikke.'.$this->Session->read('Message.warning.message'), null, array(), 'warning');
            return $this->redirect($this->referer());
        }
        ...
        if($is_packed)
        {
            ...
            $this->Session->setFlash('Odren er nu sat til "Pakket".'.$this->Session->read('Message.success.message'), null, array(), 'success');
    ...
    public function send($order_id = null)
    {
        if($this->request->is('post'))
        {
            ...
            $this->Session->setFlash('Odren er nu sat til "Sendt".'.$this->Session->read('Message.success.message'), null, array(), 'success');
