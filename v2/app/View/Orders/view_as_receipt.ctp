...
<p class="text-muted" style="width:50%; float:left;">
    Ordre nr. <?php echo $order['Order']['id']; ?> - Transaktion nr. <?php echo $order['Order']['transaction_id']; ?>
    <?php if ($order['Order']['delivery_label'])   { ?>
    - Tracking nr. <?php echo $order['Order']['delivery_label']; ?>
<!-- Submit Button -->
<p class="text-center">
<a style="font-size:1.3em;" href="
    <?php echo $this->Html->url(array('controller' => 'orders', 'action' => 'tracking', $order['Order']['id'])); ?>
" class="btn btn-primary btn-md"><span class="glyphicon glyphicon-barcode"></span> Send trackingnummer</a>
</p>
    <?php } ?>
</p>
<hr/>
