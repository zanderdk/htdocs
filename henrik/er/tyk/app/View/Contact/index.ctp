...
<div class="row">
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
            ...
            <?php echo $this->Form->input('name', array('label' => 'Navn', 'value' => $email['name'])); ?>
            <br/>
            <?php echo $this->Form->input('email', array('label' => 'Email' , 'value' => $email['email'])); ?>
            <br/>
            <?php echo $this->Form->input('subject', array('label' => 'Emne', 'required', 'value' => $email['subject'])); ?>
            <br/>
            <?php echo $this->Form->input('textarea', array('rows' => '5', 'label' => 'Besked', 'required', 'value' => $email['textarea']));?>
            <br/>
